...
check ops_are_exhaustive {
  all op: Operation |
    ...
    op in Rename or 
    op in Rmdir 
} for 1 Volatile, exactly 10 PMObj, exactly 1 Root, exactly 1 NoInode, exactly 1 NoDentry, 1 Operation, 1..1 steps

check check_fs_Write_Write {
  ((first & Operation) in Write and (first & Operation).next in Write) =>
    check_fs_pred
} for 1 Volatile, exactly 10 PMObj, exactly 1 Root, exactly 1 NoInode, exactly 1 NoDentry, 2 Operation, 30..30 steps

check check_fs_Write_Create {
  ((first & Operation) in Write and (first & Operation).next in Create) =>
    check_fs_pred
} for 1 Volatile, exactly 10 PMObj, exactly 1 Root, exactly 1 NoInode, exactly 1 NoDentry, 2 Operation, 30..30 steps

check check_fs_Write_Mkdir {
  ((first & Operation) in Write and (first & Operation).next in Mkdir) =>
    check_fs_pred
} for 1 Volatile, exactly 10 PMObj, exactly 1 Root, exactly 1 NoInode, exactly 1 NoDentry, 2 Operation, 30..30 steps

check check_fs_Write_Ftruncate {
  ((first & Operation) in Write and (first & Operation).next in Ftruncate) =>
    check_fs_pred
} for 1 Volatile, exactly 10 PMObj, exactly 1 Root, exactly 1 NoInode, exactly 1 NoDentry, 2 Operation, 30..30 steps

check check_fs_Write_Unlink {
  ((first & Operation) in Write and (first & Operation).next in Unlink) =>
    check_fs_pred
} for 1 Volatile, exactly 10 PMObj, exactly 1 Root, exactly 1 NoInode, exactly 1 NoDentry, 2 Operation, 30..30 steps

check check_fs_Write_Rename {
  ((first & Operation) in Write and (first & Operation).next in Rename) =>
    check_fs_pred
} for 1 Volatile, exactly 10 PMObj, exactly 1 Root, exactly 1 NoInode, exactly 1 NoDentry, 2 Operation, 30..30 steps

check check_fs_Write_Rmdir {
  ((first & Operation) in Write and (first & Operation).next in Rmdir) =>
    check_fs_pred
} for 1 Volatile, exactly 10 PMObj, exactly 1 Root, exactly 1 NoInode, exactly 1 NoDentry, 2 Operation, 30..30 steps

check check_fs_Create_Write {
  ((first & Operation) in Create and (first & Operation).next in Write) =>
    check_fs_pred
} for 1 Volatile, exactly 10 PMObj, exactly 1 Root, exactly 1 NoInode, exactly 1 NoDentry, 2 Operation, 30..30 steps

check check_fs_Create_Create {
  ((first & Operation) in Create and (first & Operation).next in Create) =>
    check_fs_pred
} for 1 Volatile, exactly 10 PMObj, exactly 1 Root, exactly 1 NoInode, exactly 1 NoDentry, 2 Operation, 30..30 steps

check check_fs_Create_Mkdir {
  ((first & Operation) in Create and (first & Operation).next in Mkdir) =>
    check_fs_pred
} for 1 Volatile, exactly 10 PMObj, exactly 1 Root, exactly 1 NoInode, exactly 1 NoDentry, 2 Operation, 30..30 steps

check check_fs_Create_Ftruncate {
  ((first & Operation) in Create and (first & Operation).next in Ftruncate) =>
    check_fs_pred
} for 1 Volatile, exactly 10 PMObj, exactly 1 Root, exactly 1 NoInode, exactly 1 NoDentry, 2 Operation, 30..30 steps

check check_fs_Create_Unlink {
  ((first & Operation) in Create and (first & Operation).next in Unlink) =>
    check_fs_pred
} for 1 Volatile, exactly 10 PMObj, exactly 1 Root, exactly 1 NoInode, exactly 1 NoDentry, 2 Operation, 30..30 steps

check check_fs_Create_Rename {
  ((first & Operation) in Create and (first & Operation).next in Rename) =>
    check_fs_pred
} for 1 Volatile, exactly 10 PMObj, exactly 1 Root, exactly 1 NoInode, exactly 1 NoDentry, 2 Operation, 30..30 steps

check check_fs_Create_Rmdir {
  ((first & Operation) in Create and (first & Operation).next in Rmdir) =>
    check_fs_pred
} for 1 Volatile, exactly 10 PMObj, exactly 1 Root, exactly 1 NoInode, exactly 1 NoDentry, 2 Operation, 30..30 steps

check check_fs_Mkdir_Write {
  ((first & Operation) in Mkdir and (first & Operation).next in Write) =>
    check_fs_pred
} for 1 Volatile, exactly 10 PMObj, exactly 1 Root, exactly 1 NoInode, exactly 1 NoDentry, 2 Operation, 30..30 steps

check check_fs_Mkdir_Create {
  ((first & Operation) in Mkdir and (first & Operation).next in Create) =>
    check_fs_pred
} for 1 Volatile, exactly 10 PMObj, exactly 1 Root, exactly 1 NoInode, exactly 1 NoDentry, 2 Operation, 30..30 steps

check check_fs_Mkdir_Mkdir {
  ((first & Operation) in Mkdir and (first & Operation).next in Mkdir) =>
    check_fs_pred
} for 1 Volatile, exactly 10 PMObj, exactly 1 Root, exactly 1 NoInode, exactly 1 NoDentry, 2 Operation, 30..30 steps

check check_fs_Mkdir_Ftruncate {
  ((first & Operation) in Mkdir and (first & Operation).next in Ftruncate) =>
    check_fs_pred
} for 1 Volatile, exactly 10 PMObj, exactly 1 Root, exactly 1 NoInode, exactly 1 NoDentry, 2 Operation, 30..30 steps

check check_fs_Mkdir_Unlink {
  ((first & Operation) in Mkdir and (first & Operation).next in Unlink) =>
    check_fs_pred
} for 1 Volatile, exactly 10 PMObj, exactly 1 Root, exactly 1 NoInode, exactly 1 NoDentry, 2 Operation, 30..30 steps

check check_fs_Mkdir_Rename {
  ((first & Operation) in Mkdir and (first & Operation).next in Rename) =>
    check_fs_pred
} for 1 Volatile, exactly 10 PMObj, exactly 1 Root, exactly 1 NoInode, exactly 1 NoDentry, 2 Operation, 30..30 steps

check check_fs_Mkdir_Rmdir {
  ((first & Operation) in Mkdir and (first & Operation).next in Rmdir) =>
    check_fs_pred
} for 1 Volatile, exactly 10 PMObj, exactly 1 Root, exactly 1 NoInode, exactly 1 NoDentry, 2 Operation, 30..30 steps

check check_fs_Ftruncate_Write {
  ((first & Operation) in Ftruncate and (first & Operation).next in Write) =>
    check_fs_pred
} for 1 Volatile, exactly 10 PMObj, exactly 1 Root, exactly 1 NoInode, exactly 1 NoDentry, 2 Operation, 30..30 steps

check check_fs_Ftruncate_Create {
  ((first & Operation) in Ftruncate and (first & Operation).next in Create) =>
    check_fs_pred
} for 1 Volatile, exactly 10 PMObj, exactly 1 Root, exactly 1 NoInode, exactly 1 NoDentry, 2 Operation, 30..30 steps

check check_fs_Ftruncate_Mkdir {
  ((first & Operation) in Ftruncate and (first & Operation).next in Mkdir) =>
    check_fs_pred
} for 1 Volatile, exactly 10 PMObj, exactly 1 Root, exactly 1 NoInode, exactly 1 NoDentry, 2 Operation, 30..30 steps

check check_fs_Ftruncate_Ftruncate {
  ((first & Operation) in Ftruncate and (first & Operation).next in Ftruncate) =>
    check_fs_pred
} for 1 Volatile, exactly 10 PMObj, exactly 1 Root, exactly 1 NoInode, exactly 1 NoDentry, 2 Operation, 30..30 steps

check check_fs_Ftruncate_Unlink {
  ((first & Operation) in Ftruncate and (first & Operation).next in Unlink) =>
    check_fs_pred
} for 1 Volatile, exactly 10 PMObj, exactly 1 Root, exactly 1 NoInode, exactly 1 NoDentry, 2 Operation, 30..30 steps

check check_fs_Ftruncate_Rename {
  ((first & Operation) in Ftruncate and (first & Operation).next in Rename) =>
    check_fs_pred
} for 1 Volatile, exactly 10 PMObj, exactly 1 Root, exactly 1 NoInode, exactly 1 NoDentry, 2 Operation, 30..30 steps

check check_fs_Ftruncate_Rmdir {
  ((first & Operation) in Ftruncate and (first & Operation).next in Rmdir) =>
    check_fs_pred
} for 1 Volatile, exactly 10 PMObj, exactly 1 Root, exactly 1 NoInode, exactly 1 NoDentry, 2 Operation, 30..30 steps

check check_fs_Unlink_Write {
  ((first & Operation) in Unlink and (first & Operation).next in Write) =>
    check_fs_pred
} for 1 Volatile, exactly 10 PMObj, exactly 1 Root, exactly 1 NoInode, exactly 1 NoDentry, 2 Operation, 30..30 steps

check check_fs_Unlink_Create {
  ((first & Operation) in Unlink and (first & Operation).next in Create) =>
    check_fs_pred
} for 1 Volatile, exactly 10 PMObj, exactly 1 Root, exactly 1 NoInode, exactly 1 NoDentry, 2 Operation, 30..30 steps

check check_fs_Unlink_Mkdir {
  ((first & Operation) in Unlink and (first & Operation).next in Mkdir) =>
    check_fs_pred
} for 1 Volatile, exactly 10 PMObj, exactly 1 Root, exactly 1 NoInode, exactly 1 NoDentry, 2 Operation, 30..30 steps

check check_fs_Unlink_Ftruncate {
  ((first & Operation) in Unlink and (first & Operation).next in Ftruncate) =>
    check_fs_pred
} for 1 Volatile, exactly 10 PMObj, exactly 1 Root, exactly 1 NoInode, exactly 1 NoDentry, 2 Operation, 30..30 steps

check check_fs_Unlink_Unlink {
  ((first & Operation) in Unlink and (first & Operation).next in Unlink) =>
    check_fs_pred
} for 1 Volatile, exactly 10 PMObj, exactly 1 Root, exactly 1 NoInode, exactly 1 NoDentry, 2 Operation, 30..30 steps

check check_fs_Unlink_Rename {
  ((first & Operation) in Unlink and (first & Operation).next in Rename) =>
    check_fs_pred
} for 1 Volatile, exactly 10 PMObj, exactly 1 Root, exactly 1 NoInode, exactly 1 NoDentry, 2 Operation, 30..30 steps

check check_fs_Unlink_Rmdir {
  ((first & Operation) in Unlink and (first & Operation).next in Rmdir) =>
    check_fs_pred
} for 1 Volatile, exactly 10 PMObj, exactly 1 Root, exactly 1 NoInode, exactly 1 NoDentry, 2 Operation, 30..30 steps

check check_fs_Rename_Write {
  ((first & Operation) in Rename and (first & Operation).next in Write) =>
    check_fs_pred
} for 1 Volatile, exactly 10 PMObj, exactly 1 Root, exactly 1 NoInode, exactly 1 NoDentry, 2 Operation, 30..30 steps

check check_fs_Rename_Create {
  ((first & Operation) in Rename and (first & Operation).next in Create) =>
    check_fs_pred
} for 1 Volatile, exactly 10 PMObj, exactly 1 Root, exactly 1 NoInode, exactly 1 NoDentry, 2 Operation, 30..30 steps

check check_fs_Rename_Mkdir {
  ((first & Operation) in Rename and (first & Operation).next in Mkdir) =>
    check_fs_pred
} for 1 Volatile, exactly 10 PMObj, exactly 1 Root, exactly 1 NoInode, exactly 1 NoDentry, 2 Operation, 30..30 steps

check check_fs_Rename_Ftruncate {
  ((first & Operation) in Rename and (first & Operation).next in Ftruncate) =>
    check_fs_pred
} for 1 Volatile, exactly 10 PMObj, exactly 1 Root, exactly 1 NoInode, exactly 1 NoDentry, 2 Operation, 30..30 steps

check check_fs_Rename_Unlink {
  ((first & Operation) in Rename and (first & Operation).next in Unlink) =>
    check_fs_pred
} for 1 Volatile, exactly 10 PMObj, exactly 1 Root, exactly 1 NoInode, exactly 1 NoDentry, 2 Operation, 30..30 steps

check check_fs_Rename_Rename {
  ((first & Operation) in Rename and (first & Operation).next in Rename) =>
    check_fs_pred
} for 1 Volatile, exactly 10 PMObj, exactly 1 Root, exactly 1 NoInode, exactly 1 NoDentry, 2 Operation, 30..30 steps

check check_fs_Rename_Rmdir {
  ((first & Operation) in Rename and (first & Operation).next in Rmdir) =>
    check_fs_pred
} for 1 Volatile, exactly 10 PMObj, exactly 1 Root, exactly 1 NoInode, exactly 1 NoDentry, 2 Operation, 30..30 steps

check check_fs_Rmdir_Write {
  ((first & Operation) in Rmdir and (first & Operation).next in Write) =>
    check_fs_pred
} for 1 Volatile, exactly 10 PMObj, exactly 1 Root, exactly 1 NoInode, exactly 1 NoDentry, 2 Operation, 30..30 steps

check check_fs_Rmdir_Create {
  ((first & Operation) in Rmdir and (first & Operation).next in Create) =>
    check_fs_pred
} for 1 Volatile, exactly 10 PMObj, exactly 1 Root, exactly 1 NoInode, exactly 1 NoDentry, 2 Operation, 30..30 steps

check check_fs_Rmdir_Mkdir {
  ((first & Operation) in Rmdir and (first & Operation).next in Mkdir) =>
    check_fs_pred
} for 1 Volatile, exactly 10 PMObj, exactly 1 Root, exactly 1 NoInode, exactly 1 NoDentry, 2 Operation, 30..30 steps

check check_fs_Rmdir_Ftruncate {
  ((first & Operation) in Rmdir and (first & Operation).next in Ftruncate) =>
    check_fs_pred
} for 1 Volatile, exactly 10 PMObj, exactly 1 Root, exactly 1 NoInode, exactly 1 NoDentry, 2 Operation, 30..30 steps

check check_fs_Rmdir_Unlink {
  ((first & Operation) in Rmdir and (first & Operation).next in Unlink) =>
    check_fs_pred
} for 1 Volatile, exactly 10 PMObj, exactly 1 Root, exactly 1 NoInode, exactly 1 NoDentry, 2 Operation, 30..30 steps

check check_fs_Rmdir_Rename {
  ((first & Operation) in Rmdir and (first & Operation).next in Rename) =>
    check_fs_pred
} for 1 Volatile, exactly 10 PMObj, exactly 1 Root, exactly 1 NoInode, exactly 1 NoDentry, 2 Operation, 30..30 steps

check check_fs_Rmdir_Rmdir {
  ((first & Operation) in Rmdir and (first & Operation).next in Rmdir) =>
    check_fs_pred
} for 1 Volatile, exactly 10 PMObj, exactly 1 Root, exactly 1 NoInode, exactly 1 NoDentry, 2 Operation, 30..30 steps
