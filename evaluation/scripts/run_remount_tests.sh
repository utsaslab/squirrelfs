...
sudo -E scripts/remount_timing.sh squirrelfs $MOUNT_POINT init $OUTPUT_DIR $PM_DEVICE
sudo -E scripts/remount_timing.sh squirrelfs $MOUNT_POINT empty $OUTPUT_DIR $PM_DEVICE
sudo -E scripts/remount_timing.sh squirrelfs $MOUNT_POINT fill_device $OUTPUT_DIR $PM_DEVICE